...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // this.load.image('bg_office', 'assets/images/bg_office.png')
    // this.load.image('paper_note', 'assets/images/paper_note.png')
    ...
    // this.load.audio('bgm_main', ['assets/audio/bgm_loop.mp3'])
